package com.deliveryservice.config.log;
...
//    private final Tracer tracer;
    ...
    @Before("execution(* com.*.controller..*(..)) || execution(* com.*.usecase.kafka..*(..)) || execution(* com.delivery.deliveryconsumer..*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.*.controller..*(..)) || execution(* com.*.usecase.kafka..*(..)) || execution(* com.delivery.deliveryconsumer..*(..))", throwing = "exception")

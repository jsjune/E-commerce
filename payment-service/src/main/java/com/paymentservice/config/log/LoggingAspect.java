package com.paymentservice.config.log;
...
//    private final Tracer tracer;
    ...
    @Before("execution(* com.*.controller..*(..)) || execution(* com.*.usecase.kafka..*(..)) || execution(* com.payment.paymentconsumer..*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* com.*.controller..*(..)) || execution(* com.*.usecase.kafka..*(..)) || execution(* com.payment.paymentconsumer..*(..))", throwing = "exception")

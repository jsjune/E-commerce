package com.productservice.config.log;
...
//    private final Tracer tracer;
    ...
    @Before("execution(* com.*.controller..*(..)) || execution(* com.*.usecase.kafka..*(..)) || execution(* com.product.productconsumer..*(..))")
...
//                + result.methodName());
    ...
    @AfterThrowing(pointcut = "execution(* com.*.controller..*(..)) || execution(* com.*.usecase.kafka..*(..)) || execution(* com.product.productconsumer..*(..))", throwing = "exception")
